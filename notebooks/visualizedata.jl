...
# ╔═╡ e7a97d50-4ebf-11f0-396c-d1275ea4756f
begin 
	using Pluto
	using DataFrames
	using Plots
...
# ╔═╡ 747902d3-8d18-4421-8ece-3b2b4c2c20bb
begin 
	df_flotation = CSV.read("flotation.csv", DataFrame)
	(
		md" # Table of the flotation file",
		first(df_flotation, 5)
	) end

# ╔═╡ 6d28d344-2054-4d22-a2cc-f10a59e2fc6a
begin 
	df_drillholes = CSV.read("drillholes.csv", DataFrame)
	(
		md" # Table of the drillholes file",
		first(df_drillholes, 5)
	)
end

# ╔═╡ 4c72deae-01d9-43c7-90d5-2c86df3e2dbb
begin 
	df_comminution = CSV.read("comminution.csv", DataFrame) 
    (
	    md" # Table of the comminution file",
		first(df_comminution, 5)
	)
end
...
manifest_format = "2.0"
project_hash = "8fcec4c7da4f272a5e1641c03536a4b8956d53b5"
