...
#combining ALL Data and Preprocessing 
begin
    #ensure that DataFrames have the same size
    ...
    #features (inputs) are all other columns, except the targets
    ...
    #prepare data for Flux and ensure Float32 type
